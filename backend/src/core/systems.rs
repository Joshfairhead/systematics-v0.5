//! System: the reconciler of a Grammar and a Vocabulary.
//!
//! A `System` holds the system-relevant metadata (name, order, coherence,
//! term/connective designations) and reconciles one `Grammar` (the K_n
...
/// A System over one Order: metadata + refs to a Grammar and a Vocabulary.
...
pub struct System {
    ...
    /// Reference to the `Grammar` (structure) this System reconciles.
